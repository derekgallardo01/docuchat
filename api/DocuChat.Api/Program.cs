...
var searchSettings = new AzureSearchSettings
{
    ...
    IndexName = Environment.GetEnvironmentVariable("AZURE_SEARCH_INDEX_NAME") ?? "docuchat-index"
};

var blobSettings = new AzureBlobSettings
{
    ConnectionString = Environment.GetEnvironmentVariable("AZURE_BLOB_CONNECTION_STRING") ?? "",
    ContainerName = Environment.GetEnvironmentVariable("AZURE_BLOB_CONTAINER_NAME") ?? "docuchat-documents"
};
